...
InfoLabel.prototype = {
	...
	_init: function(label, text, reactive, can_focus) {
		...
		this._boxRight = new St.Bin({ x_align: St.Align.END })
		this._boxRight.set_width(55);
		this.addActor(this._boxRight);
		this._text = new St.Label();
		this._boxRight.add_actor(this._text);
	},
...
ProcessorLabel.prototype = {
	...
	SetWattage: function(joules) {
		this._text.set_text((joules - this._previous).toFixed(2).toString() + ' W');
...
MyApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instanceId) {
		...
		this.menu.addMenuItem(this.m_processor);
			...
			this.m_pkg = new ProcessorLabel("Package Total: ");
			this.m_processor.menu.addMenuItem(this.m_pkg);

			this.m_pp0 = new ProcessorLabel("Cores/Cache: ");
			this.m_processor.menu.addMenuItem(this.m_pp0);

			this.m_pp1 = new ProcessorLabel("Integrated GPU: ");
	...
	// added for processor functionality
